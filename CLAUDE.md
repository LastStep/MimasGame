...
5. **Game data is JSON** under `MimasClient/Assets/_Game/Data/` (items, abilities, boons, maps, modifiers, rules). Core loads it; never hard-code balance numbers in C#. Schema changes ⇒ update `docs/data.md`.
